    ...
    return (
        ...
        flex items-center justify-center">
              ...
              px-4 py-3 mt-6">Log In</button>
                        ...
                        <button type="button" className="w-full block bg-white hover:bg-gray-100 focus:bg-gray-100 text-gray-900 font-semibold rounded-lg px-4 py-3 border border-gray-300" onClick={()=> {
                            // TODO: ADD LOGIN HANDLER
                            // TODO: INTEGRATE THE API
                            // TODO: After SUccessfull Login redirect to the JSON
                            // TODO: After unsuccessfull login display a error snack bar at the top right.
